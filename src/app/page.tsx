...
export default function HomePage() {
  ...
  // Dynamic Product JSON-LD generation for search engines
  const productJsonLds = featuredProducts.map((product) => ({
    "@context": "https://schema.org",
    "@type": "Product",
    "name": product.name,
    "image": `https://ambikahandloom.com${product.image}`,
    ...
    "offers": {
      "@type": "Offer",
      "url": `https://ambikahandloom.com/catalog`,
      "priceCurrency": "INR",
      "price": product.price,
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(productJsonLds) }}
      />
      {/* ===== HERO SECTION ===== */}
      ...
      {/* ===== THE CRAFT SECTION ===== */}
      <section className="py-20 md:py-32 bg-obsidian text-cream">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          ...
          >
            ...
            <h2 className="font-serif text-4xl md:text-6xl lg:text-7xl tracking-tight leading-[0.95] mb-6">
              Every Thread Tells
              <br />
              <span className="text-indigo-deep">A Story</span>
            </h2>
